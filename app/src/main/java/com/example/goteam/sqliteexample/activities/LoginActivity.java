...
import com.example.goteam.sqliteexample.sql.DatabaseHelper;
import com.example.goteam.sqliteexample.sql.DatabaseManager;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void verifyFromSQLite() {
        ...
        if (databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim()
            ...
            Intent insertIntent = new Intent(activity, InsertModules.class);
            insertIntent.putExtra("EMAIL", textInputEditTextEmail.getText().toString().trim());
            emptyInputEditText();
